...
public class Lista {
	...
	public static void main(String[] args) {
		...
		System.out.println(aprovados.remove("maria")); // Retornará um 'false', pois, este elemento não existe
		System.out.println(aprovados.remove("Maria")); // Retornará um 'false', pois, este elemento não existe
		System.out.println(aprovados.size());
		
		for(String nome: aprovados) {
			System.out.println(nome); // Exibe a lista contendo todos os nomes
		}
	}
}
